...
export const router = createRouter({ history: createWebHistory('/next/'), routes: [
  ...
  { path: '/alerts', component: AlertsView }, { path: '/notifications', component: NotificationsView }, { path: '/instances', component: InstancesView }, { path: '/audits', component: AuditsView },
] })
