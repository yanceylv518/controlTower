...
const reset = () => { username.value = ''; tokenName.value = ''; modelName.value = ''; requestID.value = ''; logType.value = undefined; advancedOpen.value = false; timeRange.value = [new Date(new Date().setHours(0, 0, 0, 0)), new Date()]; search() }
