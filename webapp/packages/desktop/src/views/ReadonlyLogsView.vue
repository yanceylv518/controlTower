...
.retry-hover-card {
  ...
  display: flex;
  --rc35-ink-2: #525252;
  --rc35-amber: oklch(0.681 0.162 75.834);
...
.token-tone-amber, .token-tone-orange, .token-tone-yellow { --identity-ink: oklch(0.681 0.162 75.834); }
.token-tone-blue, .token-tone-indigo { --identity-ink: oklch(0.72 0.18 250); }
.token-tone-cyan, .token-tone-teal { --identity-ink: oklch(0.65 0.15 200); }
.token-tone-green { --identity-ink: oklch(0.596 0.145 163.225); }
.token-tone-light-green { --identity-ink: #10b981; }
.token-tone-grey, .token-tone-hidden { --identity-ink: #737373; }
.token-tone-light-blue { --identity-ink: oklch(0.588 0.158 241.966); }
.token-tone-lime { --identity-ink: oklch(0.7 0.12 280); }
.token-tone-pink { --identity-ink: oklch(0.68 0.16 155); }
.token-tone-purple, .token-tone-violet { --identity-ink: oklch(0.68 0.19 325); }
.token-tone-red { --identity-ink: oklch(0.577 0.245 27.325); }
...
.token-badge, .model-badge { width: fit-content; height: 24px; min-height: 24px; padding: 0 8px; gap: 6px; border: 1px solid oklch(0.93 0 0 / 60%); border-radius: 6px; background: oklch(0.97 0 0 / 30%); color: #171717; font-weight: 500; text-align: left; }
.token-badge svg, .model-icon { flex: none; }
.model-icon { width: 18px; height: 18px; object-fit: contain; }
.group-meta { color: #737373; }
.group-meta .ratio { color: #73737399; font-variant-numeric: tabular-nums; }
.stream-cell { gap: 3px; }
.stream-label {
  display: inline-flex;
  width: fit-content;
...
.cost-text { display: inline-block; padding: 2px 8px; border: 1px solid oklch(0.93 0 0 / 60%); border-radius: 6px; background: oklch(0.97 0 0 / 30%); font-weight: 600; }
...
.timing-segment.timing-warning { background: #eab308; }
.timing-segment.timing-danger { background: #dc2626; }
...
.timing-value.timing-warning b { color: #d6a200; }
.timing-value.timing-danger b { color: #dc2626; }
