...
.customer-kpi::before { content: ""; position: absolute; inset: 0 auto 0 0; width: 3px; background: var(--ct-primary-solid); opacity: .8; }
.customer-kpi:nth-child(2)::before { background: var(--ct-primary-solid); }.customer-kpi:nth-child(3)::before { background: var(--ct-warning-solid); }.customer-kpi:nth-child(4)::before { background: var(--ct-purple); }.customer-kpi.tpm::before { background: var(--ct-primary-solid); }.customer-kpi:nth-child(6)::before { background: var(--ct-success-solid); }.customer-kpi.danger::before { background: var(--ct-warning-solid); }
