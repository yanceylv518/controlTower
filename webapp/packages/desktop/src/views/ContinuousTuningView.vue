...
const defaults = () => ({ sensitivity: 1, speed_exponent: .35, speed_min_factor: .75, speed_max_factor: 1.25, cache_exponent: .15, cache_min_factor: .9, cache_max_factor: 1.1, otps_exponent: .25, otps_min_factor: .8, otps_max_factor: 1.2, error_healthy_rate: .01, error_degraded_rate: .05, error_poor_rate: .15, error_floor_rate: .3, error_degraded_factor: .85, error_poor_factor: .5, error_min_factor: .2, combined_min_factor: .5, combined_max_factor: 1.5, otps_cap: 1.5, circuit_threshold: .1, recovery_threshold: .2, circuit_error_rate: .3, recovery_error_rate: .1, silent_minutes: 5, probe_interval_seconds: 5, probe_count: 10, soft_start_multiplier: .2, window_minutes: 15, min_samples: 20, sparse_lookback_minutes: 360, write_deadband_percent: 5, min_write_interval_minutes: 5 });
