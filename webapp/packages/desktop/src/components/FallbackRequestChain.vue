...
<style scoped>
.request-chain{padding:16px 20px;background:var(--rc35-surface-2,var(--ct-surface-2));border-left:3px solid var(--rc35-blue,var(--ct-accent));color:var(--rc35-ink,var(--ct-ink));font-size:12px;line-height:1.6;white-space:normal}
...
button{font:inherit;cursor:pointer;border:1px solid var(--rc35-line);border-radius:5px;background:var(--rc35-surface,var(--ct-surface));color:var(--rc35-blue);padding:4px 9px}button:focus-visible{outline:2px solid var(--rc35-blue);outline-offset:2px}.chain-actions{justify-content:flex-end}.chain-actions button:first-child{background:var(--rc35-blue);color:var(--ct-on-solid);border-color:var(--rc35-blue)}
.chain-steps{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(230px,100%),1fr));gap:12px;margin-top:14px}.chain-step{padding:12px;background:var(--rc35-surface,var(--ct-surface));border:1px solid var(--rc35-line);border-radius:7px;min-width:0}.chain-step.current{border-color:var(--rc35-blue);box-shadow:inset 0 2px var(--rc35-blue)}.step-heading{color:var(--rc35-ink-2);margin-bottom:8px}.failed{color:var(--rc35-danger,var(--ct-crit))}.consumed{color:var(--rc35-green,var(--ct-ok))}.step-channel{font-weight:500;overflow-wrap:anywhere}.step-meta{margin-top:5px;color:var(--rc35-ink-2);font-variant-numeric:tabular-nums}.step-reason{padding-top:8px;margin:8px 0;border-top:1px solid var(--rc35-line);overflow-wrap:anywhere}.step-footer{margin-top:10px}.step-footer button{margin-left:auto;border:0;padding:0}.current-label{color:var(--rc35-blue);background:var(--rc35-accent-weak);border-radius:4px;padding:1px 6px}.chain-foot{color:var(--rc35-ink-2);margin-top:12px}.chain-foot button{border:0;background:transparent}.chain-note{margin-top:8px;color:var(--rc35-ink-2);font-size:11px}.chain-notice{padding:10px 12px;background:var(--rc35-surface,var(--ct-surface));border:1px solid var(--rc35-line);border-radius:5px;margin:12px 0}.other-logs{display:flex;gap:8px;flex-wrap:wrap;border-top:1px solid var(--rc35-line);padding-top:12px;margin-top:12px}.other-logs>span{width:100%}
