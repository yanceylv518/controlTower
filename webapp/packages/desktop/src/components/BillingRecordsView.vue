...
<template>
  <AppShell :title="title" class="billing-records-shell" :class="{'upstream-records':props.billType === 'upstream'}">
    ...
    <AsyncPanel :loading="state.loading.value" :error="state.error.value" :empty="!records.length" :empty-text="`暂无${title}，请先创建账单任务`" @retry="state.reload">
      ...
      <el-table v-mobile-cards v-if="expandedUsers.includes(group.key)" :data="group.bills" row-key="id" class="records-table" scrollbar-always-on>
...
.preview-title{display:flex;align-items:center;gap:12px}.preview-title h2{margin:0;font-size:20px;color:var(--ct-ink)}.preview-title p{margin:4px 0 0;color:var(--ct-ink-3);font-size:12px}.preview-title .el-tag{margin-left:auto;margin-right:12px}.preview-mark{display:grid;place-items:center;width:42px;height:42px;border-radius:12px;color:var(--ct-on-solid);font-size:20px;font-weight:700;background:linear-gradient(135deg,var(--ct-primary-solid),var(--ct-primary-solid));box-shadow:0 7px 18px rgba(49,94,232,.24)}
.preview-body{min-height:300px}.preview-meta{display:grid;grid-template-columns:1fr 1fr 1.3fr;gap:1px;background:var(--ct-surface-2);border:1px solid var(--ct-line);border-radius:10px;overflow:hidden}.preview-meta>div{padding:13px 16px;background:var(--ct-accent-weak)}.preview-meta span{display:block;color:var(--ct-ink-3);font-size:12px;margin-bottom:5px}.preview-meta strong{color:var(--ct-ink);font-size:14px}.mono{font-family:Consolas,monospace;font-size:12px!important;font-weight:500}
.review-alert{margin-top:14px}.preview-metrics{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin:16px 0}.metric-card{position:relative;padding:16px 18px;border:1px solid var(--ct-line);border-radius:12px;background:var(--ct-surface);box-shadow:0 3px 12px rgba(35,54,90,.04)}.metric-card span{display:block;color:var(--ct-ink-3);font-size:13px}.metric-card strong{display:block;margin:7px 0 3px;color:var(--ct-ink);font-size:24px;line-height:1.2}.metric-card small{margin:0}.metric-card.accent{border-color:var(--ct-line);background:linear-gradient(135deg,var(--ct-accent-weak),var(--ct-accent-weak))}.metric-card.accent strong{color:var(--ct-accent)}
.preview-tabs{padding:0 14px 14px;border:1px solid var(--ct-line);border-radius:12px;background:var(--ct-surface)}.model-name{color:var(--ct-ink)}.money{color:var(--ct-accent)}.preview-footer{display:flex;align-items:center;justify-content:space-between}.preview-footer>span{color:var(--ct-ink-3);font-size:12px}
.danger{color:var(--ct-crit)!important}.anomaly-toolbar{display:flex;align-items:center;gap:12px;margin:12px 0}.anomaly-toolbar .el-alert{flex:1}.preview-note{margin:10px 0 0;color:var(--ct-ink-3);font-size:12px;text-align:right}
:deep(.bill-preview-dialog){border-radius:14px;overflow:hidden;box-shadow:0 24px 70px rgba(20,35,65,.2)}:deep(.bill-preview-dialog .el-dialog__header){padding:20px 24px 16px;margin:0;border-bottom:1px solid var(--ct-line)}:deep(.bill-preview-dialog .el-dialog__body){padding:18px 24px;background:var(--ct-surface-2)}:deep(.bill-preview-dialog .el-dialog__footer){padding:14px 24px;border-top:1px solid var(--ct-line)}:deep(.preview-tabs .el-tabs__header){margin-bottom:0}:deep(.preview-tabs .el-tabs__item){height:48px;font-weight:600}:deep(.preview-tabs .el-table){border-radius:8px}:deep(.preview-tabs .el-table th.el-table__cell){background:var(--ct-surface-2);color:var(--ct-ink-2);font-weight:600}
