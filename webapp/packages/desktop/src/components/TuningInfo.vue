...
<style scoped>
.tuning-info-host{display:inline-flex;vertical-align:middle}.tuning-info-button{display:grid;place-items:center;width:17px;height:17px;padding:0;border:1px solid var(--ct-line-strong);border-radius:50%;color:var(--ct-ink-2);background:transparent;font:600 11px Georgia,serif;cursor:pointer}.tuning-info-button:hover,.tuning-info-button:focus-visible{color:var(--ct-accent);border-color:var(--ct-accent);outline:2px solid var(--ct-line);outline-offset:2px}.tuning-info-body{max-height:65vh;overflow:auto;color:var(--ct-ink-2);line-height:1.65}.tuning-info-body header{display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;color:var(--ct-ink)}.tuning-info-body header button{border:0;background:none;color:var(--ct-ink-3);font-size:21px;cursor:pointer}.pin-hint{display:block;margin-top:14px;color:var(--ct-ink-3);font-size:11px}:global(.tuning-info-popover){max-width:calc(100vw - 32px);border-radius:8px!important;box-shadow:0 10px 32px #2036581c!important;padding:16px!important}
.tuning-info-button.text-trigger{display:inline-block;width:auto;height:auto;min-height:20px;border:0;border-radius:3px;font:inherit;color:inherit}.tuning-info-button.text-trigger:hover{color:var(--ct-accent)}
</style>
