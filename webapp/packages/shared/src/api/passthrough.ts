...
export const passthroughApi = (client: ApiClient) => ({
  ...
  logStat: (params: { site?: string; user_ids?: string; username?: string; group?: string; start_time?: string; end_time?: string; token_name?: string; model_name?: string; channel_id?: number }) => client.request<ReadonlyLogStatResponse>(`/api/dashboard/passthrough/logs/stat${query(params)}`),
  logCount: (params: { site?: string; user_ids?: string; username?: string; group?: string; start_time?: string; end_time?: string; token_name?: string; model_name?: string; request_id?: string; channel_id?: number; log_type?: number }) => client.request<ReadonlyLogCountResponse>(`/api/dashboard/passthrough/logs/count${query(params)}`),
})
