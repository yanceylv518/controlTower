...
func TestBillingRequestsReturnsBoundedRequestIDs(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/api/dashboard/billing/requests?instance_id=site-a&user_id=7&from=2026-08-01+00:00:00&to=2026-08-02+00:00:00&page_size=1&after_id=10", nil)
	...
	if source.cursor.ID != 10 || source.limit != 2 {
