...
func TestValidateSettings(t *testing.T) {
	bad := Validate(map[string]string{CPUWarn: "95", CPUCrit: "90", RetentionDetail: "0", RetentionHealthHours: "169", P95Warn: "0.1", TTFTP50Threshold: "30", TTFTP90Threshold: "20", BalanceWarnDays: "2", BalanceCritDays: "3", BalanceLookbackHours: "12"})
	for _, key := range []string{CPUWarn, RetentionDetail, RetentionHealthHours, P95Warn, TTFTP50Threshold, BalanceCritDays, BalanceLookbackHours} {
		if bad[key] == "" {
