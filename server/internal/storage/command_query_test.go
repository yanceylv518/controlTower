...
func TestIsConfigurationAuditOperation(t *testing.T) {
	for _, operation := range []string{"auth.account_create", "auth.account_update", "auth.password_reset", "settings.update", "billing.price_update", "billing.group_ratio_update", "billing.model_metadata_update", "billing.models_sync", "channel.update"} {
